      ...
      <section className="flex justify-left items-center border rounded-lg my-10 mx-20">
        <div className="flex m-8 flex-col">
          ...
          <ul className="mx-5 mb-32 list-decimal">
            ...
            <li>
              <Link className="text-blue-400" href="#Services">
                Our services
              </Link>
            </li>
            <li>
              <Link className="text-blue-400" href="#IP">
                Intellectual property rights
              </Link>
            </li>
            <li>
              <Link className="text-blue-400" href="#User representations">
                User representations
              </Link>
            </li>
            <li>
              <Link className="text-blue-400" href="#User registration">
                User registration
              </Link>
            </li>
            <li>
              <Link className="text-blue-400" href="#Prohibited">
                Prohibited activities
              </Link>
            </li>
            <li>
              <Link className="text-blue-400" href="#User generated">
                User generated contributions
              </Link>
            </li>
            <li>
              <Link className="text-blue-400" href="#Contribution">
                Contribution licence
              </Link>
            </li>
            <li>
              <Link className="text-blue-400" href="#Guidelines">
                Guidelines for reviews
              </Link>
            </li>
            <li>
              <Link className="text-blue-400" href="#Social">
                Social media
              </Link>
            </li>
            <li>
              <Link className="text-blue-400" href="#Third-party">
                Third-party websites and content
              </Link>
            </li>
            <li>
              <Link className="text-blue-400" href="#Services management">
            ...
            <li>
              <Link className="text-blue-400" href="#Copyright">
                Copyright infringements
              </Link>
            </li>
            <li>
              <Link className="text-blue-400" href="#Term">
                Term and termination
              </Link>
            </li>
            <li>
              <Link className="text-blue-400" href="#Modifications">
                Modifications and interruptions
              </Link>
            </li>
            <li>
              <Link className="text-blue-400" href="#Governing">
                Governing law
              </Link>
            </li>
            <li>
              <Link className="text-blue-400" href="#Dispute">
                Dispute resolution
              </Link>
            </li>
            <li>
              <Link className="text-blue-400" href="#Corrections">
                Corrections
              </Link>
            </li>
            <li>
              <Link className="text-blue-400" href="#Disclaimer">
                Disclaimer
              </Link>
            </li>
            <li>
              <Link className="text-blue-400" href="#Limitations">
                Limitations of liability
              </Link>
            </li>
            <li>
              <Link className="text-blue-400" href="#Indemnification">
                Indemnification
              </Link>
            </li>
            <li>
              <Link className="text-blue-400" href="#User data">
                User data
              </Link>
            </li>
            <li>
              <Link className="text-blue-400" href="#Electronic">
                Electronic communications, transactions, and signatures
              </Link>
            </li>
            <li>
              <Link className="text-blue-400" href="#California">
                California users and residents
              </Link>
            </li>
            <li>
              <Link className="text-blue-400" href="#Miscellaneous">
                Miscellaneous
              </Link>
            </li>
            <li>
          ...
          <p className="mb-5">
            ...
            provide a safe and transparent way for volunteer and charity
            contributions to be shared with the public. You can contact us by
            email at admin@bcharity.net. These Legal Terms constitute a legally
            binding agreement made between you, whether personally or on behalf
            of an entity ('you'), and BCharity, concerning your access to and
            ...
            documents that may be posted on the Services from time to time are
            ...
            Services after the date such revised Legal Terms are posted. The
          ...
          <p className="mb-5">
            ...
            personal, non-commercial use or internal business purpose only. Your
            use of our Services Subject to your compliance with these Legal
            Terms, including the 'PROHIBITED ACTIVITIES' section below, we grant
            you a non-exclusive, non-transferable, revocable licence to: access
            ...
            to: admin@bcharity.net. If we ever grant you the permission to post,
            ...
            notice appears or is visible on posting, reproducing, or displaying
            our Content. We reserve all rights not expressly granted to you in
            and to the Services, Content, and Marks. Any breach of these
            ...
            acknowledgment or compensation to you. Contributions: The Services
            ...
            other users of the Services and possibly through third-party
            websites. When you post Contributions, you grant us a licence
            ...
            channels. This licence includes our use of your name, company name,
            and franchise name, as applicable, and any of the trademarks,
            service marks, trade names, logos, and personal and commercial
            images you provide. You are responsible for what you post or upload:
            ...
            licences to submit such Submissions and/or Contributions and that
          ...
          <p className="mb-5">
            ...
            without written permission from us. Trick, defraud, or mislead us
            ...
            including features that prevent or restrict the use or copying of
            any Content or enforce limitations on the use of the Services and/or
            the Content contained therein. Disparage, tarnish, or otherwise
            harm, in our opinion, us and/or the Services. Use any information
            ...
            unauthorised framing of or linking to the Services. Upload or
            ...
            another user. Upload or transmit (or attempt to upload or to
            ...
            measures of the Services designed to prevent or restrict access to
            the Services, or any portion of the Services. Copy or adapt the
            ...
            use or launch any unauthorised script or other software. Use a
            ...
            Services as part of any effort to compete with us or otherwise use
          ...
          <p className="mb-5">
            ...
            owner of or have the necessary licences, rights, consents, releases,
            and permissions to use and to authorise us, the Services, and other
            ...
            anyone. Your Contributions are not used to harass or threaten (in
            ...
            to protect the health or well-being of minors. Your Contributions do
            ...
            law or regulation. Any use of the Services in violation of the
            foregoing violates these Legal Terms and may result in, among other
          ...
          <p className="mb-5">
            ...
            any media channels. This licence will apply to any form, media, or
          ...
          <p className="mb-5">
            ...
            reviews in our sole discretion. We have absolutely no obligation to
            screen reviews or to delete reviews, even if anyone considers
            reviews objectionable or inaccurate. Reviews are not endorsed by us,
            and do not necessarily represent our opinions or the views of any of
          ...
          <p className="mb-5">
            ...
            advised the Services are hosted in Canada. If you access the
            ...
            that differ from applicable laws in Canada, then through your
            ...
            and processed in Canada. Further, we do not knowingly accept,
            ...
            Privacy Protection Act, if we receive actual knowledge that anyone
            under the age of 13 has provided personal information to us without
          ...
          <p className="mb-5">
            ...
            the jurisdiction of the Canada courts. BCharity shall also maintain
          ...
          <p className="mb-5">
            ...
            at:{' '}
            <Link className="text-blue-400" href="mailto:admin@bcharity.net">
              admin@bcharity.net
            </Link>
          </p>
        </div>
